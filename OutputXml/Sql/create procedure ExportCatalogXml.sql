if OBJECT_ID(N'ExportCatalogXml', N'P') is not null
	drop procedure ExportCatalogXml

go

create procedure ExportCatalogXml @CatalogNodeCode nvarchar(20), @output xml output as
set @output = (select 
	1.0 [@Version],
	(
		select
